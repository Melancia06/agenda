...
while($row_teste = $result->fetch(PDO::FETCH_ASSOC)){
    extract($row_teste);
    echo"ID $id<br>"; // mesma coisa que $row_teste['id'] ou seja ele faz um extract fazendo com que minhas variaveis sejam identificada como variavel para poder associar no banco
