...
$insert= bindParam(":quimicalab", $nome); // existe o param(para variavel comum com $nome) e o value (para objeto sendo distanciado assim $dados->bindValue(':nome', $objeto->getNome())).
