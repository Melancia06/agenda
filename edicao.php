        ...
        <div class="campo_favorito">
            <h4 class="man">Escolha uma opção para autalizar:
                ...
                if(isset($row_laboratorio['fisicalab']) AND ($row_laboratorio['fisicalab'] == 1)){
                    ...
                    $selecionado = '<label>Laboratório de Física</label>'.'<input type="checkbox" name="fisicalab" value="1" '. '<br><br>';
                }
                         ?>
                ...
                if(isset($row_laboratorio['quimicalab']) AND ($row_laboratorio['quimicalab'] == 1)){
                    ...
                    $selecionado = ' <label>Laboratório de Química</label>'.'<input type="checkbox" name="quimicalab" value="1"  '. ' <br><br>';
                }
                         ?>
                ...
                if(isset($row_laboratorio['biologialab']) AND ($row_laboratorio['biologialab'] == 1)){
                    ...
                    $selecionado = '<label>Laboratório de Biologia</label>' . '<input type="checkbox" name="biologialab"  value="1"' . ' <br><br>';
                }
                         ?>
                ...
                if(isset($row_laboratorio['ingleslab']) AND ($row_laboratorio['ingleslab'] == 1)){
                    ...
                    $selecionado ='<label>Laboratório de Inglês </label>' . '<input type="checkbox" name="ingleslab"  value="1" ' . '<br><br>';
                }
                         ?>
                ...
                <input type="submit" name="atualizei" value="atualizar">
            </h4>
        </div>
    </form>
</body>
